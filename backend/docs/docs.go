...
const docTemplate = `{
        ...
        "schemas": {
            ...
            "catchrefs.Refs": {
                "properties": {
                    "abilities": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Ability"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "balls": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Ball"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "marks": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Mark"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "natures": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Nature"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "ribbons": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Ribbon"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "detector.templateUploadRequest": {
                "properties": {
                    "calibration": {
                        "description": "Calibration is the opaque stability calibration JSON computed by the\nfrontend test step; persisted as-is.",
                        "items": {
                            "type": "integer"
                        },
                        "type": "array",
                    ...
                    "precision": {
                        "description": "The detection-setting fields below seed this template's own values;\nnil means the engine's hardcoded fallback applies.",
                        "type": "number"
                    },
                    "regions": {
                        "items": {
            ...
            "games.locationsResponse": {
                "properties": {
                    ...
                    "locations": {
                        "items": {
                            "$ref": "#/components/schemas/catchrefs.Location"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "state.AppState": {
                "properties": {
                    ...
                    "sessions": {
                        "items": {
                            "$ref": "#/components/schemas/state.Session"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "settings": {
                        "$ref": "#/components/schemas/state.Settings"
                    }
                },
                "type": "object"
            },
            "state.CatchMeta": {
                "description": "Catch holds the optional details recorded for this catch. Nil means\nnothing was recorded, which is the state of every entry predating the\nfeature and of every hunt that is not finished yet.",
                "properties": {
                    "ability": {
                        "type": "string"
                    },
            ...
            "state.DetectorConfig": {
                "properties": {
                    ...
                    "templates": {
                        ...
                        "items": {
                            "$ref": "#/components/schemas/state.DetectorTemplate"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "state.DetectorTemplate": {
                "properties": {
                    "calibration": {
                        "description": "Calibration holds frontend-computed stability calibration as an opaque\nJSON object. The backend only persists and forwards it; the detection\nengine in the frontend owns its shape.",
                        "items": {
                            "type": "integer"
                        },
                        "type": "array",
                    ...
                    "consecutive_hits": {
                        "description": "ConsecutiveHits is this template's own required consecutive matching\nframes before counting an encounter. nil falls back to a hardcoded default.",
                        "type": "integer"
                    },
                    "cooldown_sec": {
                        "description": "CooldownSec is this template's own minimum seconds between counts.\nnil falls back to a hardcoded default.",
                        "type": "integer"
                    },
                    "enabled": {
                    ...
                    "hysteresis_factor": {
                        "description": "HysteresisFactor is this template's own hysteresis exit-threshold\nmultiplier. nil falls back to a hardcoded default.",
                        "type": "number"
                    },
                    "hysteresis_mode": {
                    ...
                    "min_poll_ms": {
                        "description": "MinPollMs is this template's own fastest adaptive-polling interval.\nnil falls back to a hardcoded default.",
                        "type": "integer"
                    },
                    "name": {
                    ...
                    "poll_interval_ms": {
                        "description": "PollIntervalMs is this template's own base adaptive-polling interval.\nnil falls back to a hardcoded default.",
                        "type": "integer"
                    },
                    "precision": {
                        "description": "Precision is this template's own NCC match threshold (0.0-1.0). nil\nmeans no explicit value has been set yet; the detection engine falls\nback to a hardcoded default.",
                        "type": "number"
                    },
                    "regions": {
                        "items": {
            ...
            "state.LabeledTextElement": {
                "description": "TotalTimer renders the hunt time across all phases. Like Timer it offers\nan idle animation only, which saves one animation channel.",
                "properties": {
                    "height": {
                        "type": "integer"
                    },
            ...
            "state.OverlaySettings": {
                ...
                "properties": {
                    ...
                    "counter": {
                        "$ref": "#/components/schemas/state.CounterElement"
                    },
                    "hidden": {
                        "type": "boolean"
                    },
                    ...
                    "phase": {
                        "$ref": "#/components/schemas/state.LabeledTextElement"
                    },
                    "show_border": {
                        "type": "boolean"
                    },
            ...
            "state.Pokemon": {
                "properties": {
                    ...
                    "overlay": {
                        "$ref": "#/components/schemas/state.OverlaySettings"
                    },
                    "overlay_mode": {
                    ...
                    "phase_number": {
                        "description": "PhaseNumber is the frozen number of this phase within its parent hunt\n(1-based). Zero for entries that are not phases. Immutable after creation.",
                        "type": "integer"
                    },
                    "phase_of": {
                        "description": "PhaseOf is the ID of the hunt this entry is a phase of. Empty means the\nentry is a hunt of its own. Immutable after creation.",
                        "type": "string"
                    },
                    "phase_targets": {
            ...
            "state.SpriteElement": {
                "properties": {
                    "cycle_interval_ms": {
                        "description": "CycleIntervalMs is the dwell time per sprite while cycling.",
                        "type": "integer"
                    },
                    "cycle_phase_targets": {
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/catchrefs.Refs"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/catch-refs/locations": {
            "get": {
                "parameters": [
                    {
                        "description": "Game key from /api/games",
                        "in": "query",
                        "name": "game",
                        "schema": {
                            "type": "string"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/games.locationsResponse"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/gamesync.GameEntry"
                                    },
                                    "type": "array"
                                }
                            }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/gamesync.GamesSyncResult"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/licenses.Entry"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/pokedex.Entry"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/pokemon.endPhaseRequest",
                                        "summary": "body",
                                        "description": "Off-target shiny that ended the phase"
                                    }
                                ]
                            }
                        }
                            ...
                            "application/json": {
                                "schema": {
                                    "oneOf": [
                                        ...
                                        {
                                            "$ref": "#/components/schemas/pokemon.spriteResponse"
                                        }
                                    ]
                                }
                            }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/database.OverviewStats"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/database.EncounterStats"
                                }
                            }
                        },
                        "description": "OK"
