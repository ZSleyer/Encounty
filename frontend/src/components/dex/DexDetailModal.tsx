/**
 * DexDetailModal.tsx: per-species detail view of the Pokédex.
 *
 ...
 * context and recorded catch metadata. An uncaught species still opens: the
  ...
  return (
    <li className="t-panel flex flex-col gap-3 p-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <Fact label={t("huntType.label")} value={t(`huntType.${entry.hunt_type || "encounter"}`)} />
...
/**
 * Species detail modal of the Pokédex grid. Reads nothing itself; every
 * catch it renders was already resolved onto this species by the dex index.
 */
export function DexDetailModal({
  ...
  return (
    <ModalShell title={name} size="xl" structured onClose={onClose}>
