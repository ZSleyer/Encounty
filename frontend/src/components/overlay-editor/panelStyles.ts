...
export const SELECT_CLASS =
  "w-full bg-bg-primary border border-border-input rounded-md px-2.5 py-1.5 text-xs text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-blue";

/** Shared class of the single-line text inputs in the property panel. */
export const TEXT_INPUT_CLASS =
  "w-full bg-bg-primary border border-border-input rounded-md px-2.5 py-1.5 text-xs text-text-primary";
