      ...
      <div className="flex items-center justify-between px-4 py-3 2xl:px-5 2xl:py-4 bg-bg-card/80 backdrop-blur-sm border-b border-border-subtle shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 2xl:px-4 2xl:py-2 rounded-md text-xs 2xl:text-sm font-medium bg-bg-secondary border border-border-subtle text-text-secondary hover:text-text-primary hover:border-accent-blue/30 transition-colors"
          ...
          <button
            onClick={onCancel}
            className="flex items-center gap-1.5 px-3 py-1.5 2xl:px-4 2xl:py-2 rounded-md text-xs 2xl:text-sm font-medium bg-bg-secondary border border-border-subtle text-text-secondary hover:text-text-primary transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 2xl:px-4 2xl:py-2 rounded-md text-xs 2xl:text-sm font-semibold bg-accent-blue hover:bg-accent-blue/80 text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {loadError && !loading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
            ...
            <button
              onClick={fetchScreenshot}
              className="px-4 py-2 2xl:px-5 2xl:py-2.5 rounded-md text-sm 2xl:text-base bg-accent-blue hover:bg-accent-blue/80 text-white font-medium transition-colors"
            >
              {t("regionPicker.reload")}
            </button>
          </div>
            ...
            >
              ...
              {selection && (
                <div
                  ...
                  className="border-2 border-accent-blue bg-accent-blue/20"
                />
              )}
            </button>
          </>
