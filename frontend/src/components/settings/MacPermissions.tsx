      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        {!granted && (
          <button
            ...
            className="px-3 py-1.5 rounded-none bg-accent-blue hover:bg-accent-blue/80 text-white text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-blue"
          >
            {t("permissions.grant")}
          </button>
        )}
