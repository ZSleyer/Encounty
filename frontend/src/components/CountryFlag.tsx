...
function MX({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
...
function BR({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
...
function JP({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
...
function KR({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
      <rect width="20" height="14" fill="#fff" />
...
function CN({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
...
function TW({ className }: FlagProps) {
  return (
    <svg viewBox="0 0 20 14" className={className}>
