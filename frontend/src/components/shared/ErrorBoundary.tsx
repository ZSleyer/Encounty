    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="px-4 py-1.5 rounded-none text-xs font-medium bg-bg-secondary border border-border-subtle text-text-primary hover:bg-bg-tertiary transition-colors"
        >
          Retry
        </button>
      </div>
