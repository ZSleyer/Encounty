...
const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "overlay.triggerAnimationDecrement": "Trigger Animation (Verringern)",
    "overlay.none": "Keine",
    ...
    "overlay.elementCounter": "Zähler",
    "overlay.elementTitle": "Titel",
    "overlay.sizePx": "Größe (px)",
    "overlay.bgAnimation": "Hintergrund-Animation",
    "overlay.animNone": "Keine",
    "overlay.animWaves": "Wellen (Homebrew)",
    "overlay.animGradient": "Farbverlauf",
    "overlay.animPulse": "Pulsieren",
    "overlay.animShimmer": "Schimmern",
    "overlay.animParticles": "Partikel",
    "overlay.speed": "Geschwindigkeit",
    "overlay.bgImage": "Hintergrundbild",
    "overlay.glowColor": "Glow Farbe",
    "overlay.animFloat": "Schweben",
    "overlay.animPulseShort": "Puls",
    "overlay.animWobble": "Wackeln",
    "overlay.animBounce": "Wippen",
    "overlay.animShimmerIdle": "Schimmern",
    "overlay.animBob": "Bob",
    "overlay.fontFamily": "Schriftart",
    "overlay.fontWeight": "Gewicht",
    "overlay.off": "Aus",
    "overlay.properties": "Eigenschaften",
    "overlay.titleStyle": "Titel-Stil",
    "overlay.borderOutline": "Kontur",
    "overlay.borderColor": "Kontur Farbe",
    "overlay.borderWidth": "Kontur Stärke",
    "overlay.upload": "Hochladen",
    "overlay.remove": "Entfernen",
    "overlay.bgFitTile": "Kacheln",
    "overlay.hidden": "Versteckt",
    "overlay.arrowKeys": "Pfeiltasten: 1px | Shift: 10px | Tab: wechseln",
    "overlay.animBreathe": "Atmen",
    "overlay.animGlow": "Glühen",
    "overlay.animFadeIn": "Einblenden",
    "overlay.animSlideIn": "Einsliden",
    "overlay.selectPokemon": "Wähle ein Pokémon als Ziel, um dessen Overlay-URL zu sehen.",
    ...
    // ── Hotkey Settings ──
    "hotkeys.increment": "+1 Encounter",
    "hotkeys.decrement": "-1 Encounter",
    "hotkeys.reset": "Reset",
    "hotkeys.nextPokemon": "Nächstes Pokémon",
    "hotkeys.unknownKey": "Unbekannte Taste",
    "hotkeys.unavailable": "Globale Hotkeys nicht verfügbar",
    "hotkeys.linuxHint": "Linux: {cmd} dann neu einloggen",
    "hotkeys.cancel": "Abbrechen",
    "hotkeys.record": "Aufzeichnen",
    "hotkeys.conflict": 'Gleiche Taste wie „{action}"',
    "hotkeys.pressKey": 'Drücke eine Taste für „{action}"',
    "hotkeys.escToCancel": "ESC zum Abbrechen",
    ...
    "editorTutorial.step1Title": "Vorschau",
    "editorTutorial.step1Text": "Das ist deine Overlay-Vorschau. So sieht es in OBS aus.",
    "editorTutorial.step2Title": "Ebenen",
    "editorTutorial.step2Text": "Hier kannst du Elemente ein-/ausblenden und deren Reihenfolge ändern.",
    "editorTutorial.step3Title": "Eigenschaften",
    "editorTutorial.step3Text": "Wähle ein Element aus, um Stil, Animation und Position hier anzupassen.",
    "editorTutorial.step4Title": "Werkzeugleiste",
    "editorTutorial.step4Text": "Zoom, Rückgängig, Raster und Werkzeuge findest du hier.",
    "editorTutorial.step5Title": "Elemente",
    "editorTutorial.step5Text": "Ziehe Elemente zum Verschieben. Nutze die Griffe zum Skalieren. Leertaste gedrückt halten = Hand-Werkzeug zum Schwenken.",
    "editorTutorial.skip": "Überspringen",
    "editorTutorial.next": "Weiter",
    "editorTutorial.finish": "Fertig",
  ...
  en: {
    ...
    "overlay.idleAnimation": "Idle Animation",
    "overlay.triggerAnimation": "Trigger Animation",
    "overlay.triggerAnimationDecrement": "Trigger Animation (Decrement)",
    "overlay.none": "None",
    "overlay.float": "Float",
    "overlay.bob": "Bob",
    "overlay.pulse": "Pulse",
    ...
    "overlay.elementCounter": "Counter",
    "overlay.elementTitle": "Title",
    "overlay.sizePx": "Size (px)",
    "overlay.bgAnimation": "Background Animation",
    "overlay.animNone": "None",
    "overlay.animWaves": "Waves (Homebrew)",
    "overlay.animGradient": "Gradient",
    "overlay.animPulse": "Pulse",
    "overlay.animShimmer": "Shimmer",
    "overlay.animParticles": "Particles",
    "overlay.speed": "Speed",
    "overlay.bgImage": "Background Image",
    "overlay.glowColor": "Glow Color",
    "overlay.animFloat": "Float",
    "overlay.animPulseShort": "Pulse",
    "overlay.animWobble": "Rock",
    "overlay.animBounce": "Wiggle",
    "overlay.animShimmerIdle": "Shimmer",
    "overlay.animBob": "Bob",
    "overlay.fontFamily": "Font",
    "overlay.fontWeight": "Weight",
    "overlay.off": "Off",
    "overlay.properties": "Properties",
    "overlay.titleStyle": "Title Style",
    "overlay.borderOutline": "Border",
    "overlay.borderColor": "Border Color",
    "overlay.borderWidth": "Border Width",
    "overlay.upload": "Upload",
    "overlay.remove": "Remove",
    "overlay.bgFitTile": "Tile",
    "overlay.hidden": "Hidden",
    "overlay.arrowKeys": "Arrow keys: 1px | Shift: 10px | Tab: switch",
    "overlay.animBreathe": "Breathe",
    "overlay.animGlow": "Glow",
    "overlay.animFadeIn": "Fade In",
    "overlay.animSlideIn": "Slide In",
    "overlay.selectPokemon": "Select a Pokémon as target to see its overlay URL.",
    ...
    "hotkeys.decrement": "-1 Encounter",
    "hotkeys.reset": "Reset",
    "hotkeys.nextPokemon": "Next Pokémon",
    "hotkeys.unknownKey": "Unknown key",
    "hotkeys.unavailable": "Global hotkeys unavailable",
    "hotkeys.linuxHint": "Linux: {cmd} then log out and back in",
    "hotkeys.cancel": "Cancel",
    "hotkeys.record": "Record",
    "hotkeys.conflict": "Same key as \"{action}\"",
    "hotkeys.pressKey": "Press a key for \"{action}\"",
    "hotkeys.escToCancel": "ESC to cancel",
    ...
    "editorTutorial.step1Title": "Preview",
    "editorTutorial.step1Text": "This is your overlay preview. It shows how your overlay will look in OBS.",
    "editorTutorial.step2Title": "Layers",
    "editorTutorial.step2Text": "Show or hide elements and change their stacking order here.",
    "editorTutorial.step3Title": "Properties",
    "editorTutorial.step3Text": "Select an element to adjust its style, animation, and position here.",
    "editorTutorial.step4Title": "Toolbar",
    "editorTutorial.step4Text": "Find zoom, undo, grid, and tool options here.",
    "editorTutorial.step5Title": "Elements",
    "editorTutorial.step5Text": "Drag elements to move them. Use handles to resize. Hold spacebar for the hand tool to pan the canvas.",
    "editorTutorial.skip": "Skip",
    "editorTutorial.next": "Next",
    "editorTutorial.finish": "Finish",
