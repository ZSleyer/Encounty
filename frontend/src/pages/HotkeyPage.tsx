          ...
          <section className="glass-card p-6" aria-labelledby="obs-card-title">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <input
                ...
                className="flex-1 min-w-0 px-3 py-2 bg-bg-secondary border border-border-input rounded-md text-xs 2xl:text-sm font-mono text-text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-blue"
              />
              <button
                type="button"
                onClick={handleCopy}
                aria-label={t("hotkey.obsCard.copyAria")}
                className="inline-flex items-center gap-2 px-3 py-2 rounded-md border border-border-subtle text-xs 2xl:text-sm font-semibold text-text-secondary hover:text-text-primary hover:bg-bg-hover transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-blue"
              >
                {copied ? (
