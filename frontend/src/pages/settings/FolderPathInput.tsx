  ...
  return (
    <div className="flex items-center gap-2">
      <input
        ...
        className="flex-1 bg-bg-secondary border border-border-input rounded-md px-3 py-2 text-sm 2xl:text-base text-text-primary placeholder-text-faint/50 outline-none focus:border-accent-blue/50 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--accent-blue)"
      />
      <button
        type="button"
        onClick={handlePick}
